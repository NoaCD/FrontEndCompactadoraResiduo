...
$(document).ready(function () {
    ...
    validarForm('#form-create-almacen'); //validamos le formulario
});
 ...
 * */
function init() {
    $("#btn-create-almacen").click(function (e) {
        e.preventDefault();
        if ($("#form-create-almacen").valid() == true) {
...
function enviarDatos() {
    ...
    console.log(Data);
    var ruta = "/Almacenes/CrearAlmacen"
